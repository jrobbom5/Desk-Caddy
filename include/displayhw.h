...
void my_touchpad_read (lv_indev_drv_t* indev_driver, lv_indev_data_t* data)
{
    ...
    else
    {
        ...
        // Do a bodge touchscreen calibration because I can't find out the right way to do it.
        // Top left corner reports 65296, 0, bottom right corner reports 479, 212.

        uint16_t xOffset = (65535 - 65295);
        touchX += xOffset;
        touchX = touchX * 480 / (xOffset + 479);
        touchY = touchY * 320 / 212;

        // Serial.println ("Touch X, Y = " + String (touchX) + ", " + String (touchY));
...
extern lv_color_t disp_draw_buf[screenWidth * SCR];
extern lv_color_t disp_draw_buf2[screenWidth * SCR];
